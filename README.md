# genpark-cloud-dspm-sensitive-data-discovery-risk-classifier-skill
...
> **GenPark AI Agent Skill** -- Cloud DSPM discovery engine and least-privilege IAM policy generator (Cyera style)
